...
// Define colors
    ...
    parameter GREY_BLUE = 16'h52ef;
    parameter GREY_ORANGE = 16'hb3ef;
    parameter BLUE_DARK = 16'h1129;
    parameter ORANGE_DIRT = 16'h9840;
    parameter WHITE = 16'hffff;
    parameter GREEN_BACKGROUND = 16'h6a60;
...
always @* begin
    if (!en)
        ...
        case (sprite_data[(7 - (y - SPRITE_Y)) * 8 + (7 - (x - SPRITE_X))])
            2'b00: pixel_data = ORANGE_DIRT; 
            2'b01: pixel_data = GREY_ORANGE;
            2'b10: pixel_data = BLACK;
            2'b11: pixel_data = WHITE;
            default: pixel_data = ORANGE_DIRT; // Default
        endcase
    end else begin
