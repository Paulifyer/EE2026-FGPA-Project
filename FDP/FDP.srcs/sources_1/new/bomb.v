...
module bomb(
    ...
    always @(posedge clk) begin
        ...
        if (!en) begin
            ...
            other_position_bomb <= {7'(other_position_bomb_i[20:14]),7'(other_position_bomb_i[13:7]),7'(other_position_bomb_i[6:0])};
            ...
            else if (other_position_bomb[1] != other_position_bomb_i[13:7]) begin
                other_position_bomb[1] <= other_position_bomb_i[13:7];
                start_bomb[4] <= 1;
            end
            else if (other_position_bomb[2] != other_position_bomb_i[20:14]) begin
                other_position_bomb[2] <= other_position_bomb_i[20:14];
                start_bomb[5] <= 1;
            end
            /* Explosion display and damage player health */
            /* Update Health if powerup taken */
